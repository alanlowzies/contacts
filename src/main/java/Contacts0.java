...
public class Contacts0 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.print(LINE_SEPARATOR + "Enter command: ");
            ...
            case "add":
                ...
                if (decodeResult == null) {
                    feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + LINE_SEPARATOR)
                            + "%2$s", "add", String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + LINE_SEPARATOR)
                            + String.format("\tParameters: %1$s", "NAME "
                            + "p/" + "PHONE_NUMBER "
                            + "e/" + "EMAIL") + (System.lineSeparator() + LINE_SEPARATOR)
                            + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + LINE_SEPARATOR));
                    break;
                }
            ...
            case "list":
                ...
                for (String m1 : new String[]{listAsString}) {
                    System.out.println(LINE_SEPARATOR + m1);
                }
            ...
            case "clear":
                ...
                break;
            case "help":
                feedback = (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tParameters: %1$s", "NAME "
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + LINE_SEPARATOR)) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "list", "Displays all persons as a list with index numbers.") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tExample: %1$s", "list") + (System.lineSeparator() + LINE_SEPARATOR)) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "clear", "Clears all contacts.") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tExample: %1$s", "clear") + (System.lineSeparator() + LINE_SEPARATOR)) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "exit", "Exits the program.")+ (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tExample: %1$s", "exit")) + (System.lineSeparator() + LINE_SEPARATOR) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "help", "Shows program usage instructions.")+ (System.lineSeparator() + LINE_SEPARATOR)
            ...
            default:
                feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + LINE_SEPARATOR)
                        + "%2$s", commandType, (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tParameters: %1$s", "NAME "
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + LINE_SEPARATOR)) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "find", "Finds all persons whose names contain any of the specified "
                        + "keywords (case-sensitive) and displays them as a list with index numbers.") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tParameters: %1$s", "KEYWORD [MORE_KEYWORDS]") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tExample: %1$s", "find" + " alice bob charlie") + (System.lineSeparator() + LINE_SEPARATOR)) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "list", "Displays all persons as a list with index numbers.") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tExample: %1$s", "list") + (System.lineSeparator() + LINE_SEPARATOR)) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "clear", "Clears all contacts.") + (System.lineSeparator() + LINE_SEPARATOR)
                        + String.format("\tExample: %1$s", "clear") + (System.lineSeparator() + LINE_SEPARATOR)) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "exit", "Exits the program.")
                        + String.format("\tExample: %1$s", "exit")) + (System.lineSeparator() + LINE_SEPARATOR)
                        + (String.format("%1$s: %2$s", "help", "Shows program usage instructions.")
                        + String.format("\tExample: %1$s", "help")));
                break;
            }
            for (String m : new String[]{feedback, "==================================================="}) {
                System.out.println(LINE_SEPARATOR + m);
            }
        }
    }
